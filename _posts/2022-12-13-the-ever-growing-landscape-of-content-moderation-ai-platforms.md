---
layout: post
title: The Ever-Growing Landscape of Content Moderation AI Platforms
date: 2023-01-04
author: george
stage: false
featured: false
...
Because there is a broader range of content moderation AI platforms than ever before, you will want to think carefully about your use cases to [choose a platform closely aligned with what you need](https://www.nyckel.com/blog/four-steps-to-improving-your-content-moderation/). The most important factors to consider when looking for a platform include:
...
| ----------------------------------- | ------------------------- | -------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------ | ----------------------------------------------------- |
| [Nyckel](#nyckel)                   | Text, image, tabular      | ✅ Free tier includes 1,000 invokes/month                 | None, all custom                                                                                                         | ✅ Yes                                | ❌ No                                                  |
| [Hive Moderation](#hive-moderation) | Text, image, video, audio | ❌ No                                                     | Visual moderation, text moderation, intelligent search                                                                   | ❌ No                                 | ❌ No                                                  |
| [Imagga](#imagga)                   | Image                     | ✅ Free tier includes up to 1,000 API requests            | NSFW content moderation                                                                                                  | ✅ Yes                                | ❌ No                                                  |
| [Sightengine](#sightengine)         | Text, image, video        | ✅ Free tier includes 2,000 invokes/month                 | Nudity detection, violence detection, face/people detection, image type detection, text moderation, and more             | ✅ Yes                                | ❌ No                                                  |
| [Membrace](#membrace)               | Text, image, video, audio | ✅ Trial available                                        | Image detection, text detection, video detection, audio detection                                                        | ❌ No                                 | ✅ Yes                                                 |
| [Clarifai](#clarifai)               | Text, image, video, audio | ✅ Free tier includes 1,000 invokes/month                 | Image recognition, detection, moderation, captioner; multilingual text moderation, text translation, logo detection, OCR | ✅ Yes                                | ✅ Yes                                                 |
| [Azure](#microsoft-azure)           | Text, image, video        | 🟨 No, but Microsoft offers $1 per 1,000 invokes         | Image moderation, text moderation, video moderation                                                                      | ❌ No                                 | 🟨 No, but Human Review Tool enables human moderation |
| [Spectrum Labs](#spectrum-labs)     | Text, audio               | ❌ No                                                     | User retention, text moderation                                                                                          | ✅ Yes                                | ❌ No                                                  |
| [WebPurify](#webpurify)             | Text, video, image        | ✅ Free trial available: 5-minutes of video or 100 photos | Photo moderation, profanity and offensive intent detection, video moderation, VR moderation                              | ✅ Yes                                | ✅ Yes                                                 |
